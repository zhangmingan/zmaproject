package com.cn.zmaproject.commonUtil.poiExcel;
...
public class ExcelUtil{
     ...
     * @param out 输出流
     */
    public static void exportExcel(String title,Map<String, String> headMap,int startRow,JSONArray jsonArray,String datePattern,int colWidth, OutputStream out) {
     ...
     * @param out 输出流
     */
    public static void exportExcelX(String title,Map<String, String> headMap,int startRow, JSONArray jsonArray,String datePattern,int colWidth, OutputStream out) {
        if(datePattern==null) datePattern = DEFAULT_DATE_PATTERN;
        // 声明一个工作薄
...
//        cellStyle.setFillPattern(HSSFCellStyle.SOLID_FOREGROUND);
        ...
        for (Object obj : jsonArray) {
            if(rowIndex == 65535 || rowIndex == 0){
                ...
                rowIndex = startRow;//数据内容从 rowIndex=2开始
            }
            JSONObject jo = (JSONObject) JSONObject.toJSON(obj);
    ...
    public static void downloadExcelFile(String title,Map<String,String> headMap,JSONArray ja,HttpServletResponse response){
        try {
            ...
            ExcelUtil.exportExcelX(title,headMap,2,ja,null,0,os);
